...
public class SkipListTest extends TestCase {
    ...
    private SkipList<String, Coordinates> skipList;
    
    /**
     * Create new skipList object prior to each test
     */
    public void setUp() {
    ...
    public void testSearch() {
        rect = new Rectangle("elem1", new Coordinates(0, 0, 1024,
            1024));
    ...
    /**
     * tests removeByCoordinates function
     */
